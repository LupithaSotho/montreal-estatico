            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body">
                  ...
                  <Link to="/inscripciones" className="btn btn-outline-danger mt-3">
                    Inscribirme
                  </Link>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body">
                  ...
                  <Link to="/inscripciones" className="btn btn-outline-primary mt-3">
                    Inscribirme
                  </Link>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body">
                  ...
                  <Link to="/inscripciones" className="btn btn-outline-success mt-3">
                    Inscribirme
                  </Link>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body">
                  ...
                  <Link to="/inscripciones" className="btn btn-outline-dark mt-3">
                    Inscribirme
                  </Link>
                </div>
              </div>
